...
receivers:
  ...
  filelog/log source:
    ...
    ## https://github.com/open-telemetry/opentelemetry-collector-contrib/tree/v0.149.0/receiver/filelogreceiver
    encoding: utf-8
    ...
    ## https://github.com/open-telemetry/opentelemetry-collector-contrib/tree/v0.149.0/receiver/filelogreceiver#multiline-configuration
    multiline:
...
receivers:
  ...
  filelog/my example name:
    ...
    ## rel: https://github.com/open-telemetry/opentelemetry-collector-contrib/blob/v0.149.0/pkg/stanza/docs/operators/regex_parser.md
    - type: regex_parser
      regex: (?P<timestamp>^\d{4}-\d{2}-\d{2} \d{2}:\d{2}:\d{2},\d{3} (\+|\-)\d{4})
      ## Parse timestamp from timestamp field
      ## rel: https://github.com/open-telemetry/opentelemetry-collector-contrib/blob/v0.149.0/pkg/stanza/docs/operators/time_parser.md
      timestamp:
...
receivers:
  ...
  tcplog/first receiver:
    ...
    ## rel: https://github.com/open-telemetry/opentelemetry-collector-contrib/tree/v0.149.0/receiver/tcplogreceiver#configuration
    add_attributes: true
  ...
  udplog/first receiver:
    ...
    ## Add network attributes
    ## `net.peer.name` is going to be used as processors.source.source_host
    ## rel: https://github.com/open-telemetry/opentelemetry-collector-contrib/tree/v0.149.0/receiver/udplogreceiver#configuration
    add_attributes: true
...
receivers:
  docker_stats:
    ...
    ## https://github.com/open-telemetry/opentelemetry-collector-contrib/blob/v0.149.0/receiver/dockerstatsreceiver#configuration
    excluded_images:
    ...
    ## Full list of metrics with their default config is available at https://github.com/open-telemetry/opentelemetry-collector-contrib/blob/v0.149.0/receiver/dockerstatsreceiver/documentation.md
    metrics:
...
[multiline]: https://github.com/open-telemetry/opentelemetry-collector-contrib/tree/v0.149.0/receiver/filelogreceiver#multiline-configuration
[supported_encodings]: https://github.com/open-telemetry/opentelemetry-collector-contrib/tree/v0.149.0/receiver/filelogreceiver#supported-encodings
...
[sumologicextension]: https://github.com/open-telemetry/opentelemetry-collector-contrib/tree/v0.149.0/extension/sumologicextension/README.md
[sumologicexporter]: https://github.com/open-telemetry/opentelemetry-collector-contrib/tree/v0.149.0/exporter/sumologicexporter/README.md
[syslogexporter]: https://github.com/open-telemetry/opentelemetry-collector-contrib/blob/v0.149.0/exporter/syslogexporter/README.md
...
[dockerstatsreceiver]: https://github.com/open-telemetry/opentelemetry-collector-contrib/blob/v0.149.0/receiver/dockerstatsreceiver
[dockerstatsmetrics]: https://github.com/open-telemetry/opentelemetry-collector-contrib/blob/v0.149.0/receiver/dockerstatsreceiver/documentation.md
...
[ottlfuncs]: https://github.com/open-telemetry/opentelemetry-collector-contrib/tree/v0.149.0/pkg/ottl/ottlfuncs#functions
