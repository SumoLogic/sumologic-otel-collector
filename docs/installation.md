...
| `--version`                      | `v`        | Version of Sumo Logic Distribution for OpenTelemetry Collector to install. By defult it gets latest version.                                                                 | yes, e.g. `0.73.0-sumo-1`  |
...
1. Download the release binary:
    ...
    ```bash
    curl -sLo otelcol-sumo "https://github.com/SumoLogic/sumologic-otel-collector/releases/download/v0.73.0-sumo-1/otelcol-sumo-0.73.0-sumo-1-linux_amd64"
    ```
...
1. Download the release binary:
    ...
    ```bash
    curl -sLo otelcol-sumo "https://github.com/SumoLogic/sumologic-otel-collector/releases/download/v0.73.0-sumo-1/otelcol-sumo-0.73.0-sumo-1-linux_arm64"
    ```
...
1. Download the release binary:
    ...
    ```bash
    curl -sLo otelcol-sumo "https://github.com/SumoLogic/sumologic-otel-collector/releases/download/v0.73.0-sumo-1/otelcol-sumo-0.73.0-sumo-1-darwin_amd64"
    ```
...
1. Download the release binary:
    ...
    ```bash
    curl -sLo otelcol-sumo "https://github.com/SumoLogic/sumologic-otel-collector/releases/download/v0.73.0-sumo-1/otelcol-sumo-0.73.0-sumo-1-darwin_arm64"
    ```
...
1. Set the release version variable:
   ...
   ```bash
   export RELEASE_VERSION=0.73.0-sumo-1
   ```
...
1. Create configuration:
   ...
   - Get [recommended configuration](https://github.com/SumoLogic/sumologic-otel-collector/blob/v0.73.0-sumo-1/examples/sumologic.yaml) from Sumo Logic repository and save it as `/etc/otelcol-sumo/sumologic.yaml`.
...
1. Create `/etc/otelcol-sumo/env/token.env` with your installation token, eg:
   ...
   We use `SUMOLOGIC_INSTALLATION_TOKEN` in example, as it will be autoamtically used by [recommended configuration](https://github.com/SumoLogic/sumologic-otel-collector/blob/v0.73.0-sumo-1/examples/sumologic.yaml)
