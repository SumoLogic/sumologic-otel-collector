...
Available commands:
  core            Prints the version core (e.g. the 1.2.3 in 1.2.3-sumo-4)
  sumo            Prints the sumo version (e.g. the 4 in 1.2.3-sumo-4)
  full            Prints the full version (e.g. 1.2.3-sumo-4)
...
# Prints the full version. (e.g. A.B.C-sumo-X)
full_version() {
    echo "$(version_core)-sumo-$(sumo_version)"
}
