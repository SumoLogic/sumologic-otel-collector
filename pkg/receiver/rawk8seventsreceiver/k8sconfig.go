...
// This is a copy of https://github.com/open-telemetry/opentelemetry-collector-contrib/blob/main/internal/k8sconfig/config.go
// We can't import it normally yet, since it's an internal package. We can use a normal import if/when we move to upstream
// or upstream makes this non-internal.
