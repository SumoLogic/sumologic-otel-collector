module github.com/SumoLogic/sumologic-otel-collector/pkg/processor/lookupprocessor
...
replace go.opentelemetry.io/collector/internal/componentalias => go.opentelemetry.io/collector/internal/componentalias v0.145.0
